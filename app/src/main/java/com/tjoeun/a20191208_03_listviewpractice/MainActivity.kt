...
import com.tjoeun.a20191208_03_listviewpractice.adapters.StudentAdapter
...
//        학생 목록 추가
    ...
    fun addSecondStudents(){
        ...
        secondStudentList.add(User("황현하", "경기도 성남시", true))
        ...
        secondStudentList.add(User("류찬울", "서울시 도봉구", false))
